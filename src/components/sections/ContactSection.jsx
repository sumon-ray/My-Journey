...
export default function ContactSection() {
  ...
  return (
    <section
      id="contact"
      ref={sectionRef}
      className="min-h-screen py-32 bg-black/10 backdrop-blur-xl flex items-center"
    >
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto text-center">
          <div className="contact-content">
            ...
            <div className="space-y-8">
              <div className="flex flex-col sm:flex-row gap-6 justify-center">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="interactive border-2 border-white/30 text-white hover:bg-white/10 px-10 py-4 rounded-full text-xl font-semibold bg-transparent hover:border-white/50 transition-all duration-300 transform hover:scale-110 inline-flex items-center justify-center"
                >
                  Download Resume
                </a>
              </div>

              <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-8 pt-8">
            ...
            <div className="mt-16 p-10 bg-white/5 backdrop-blur-xl rounded-3xl border border-white/10 relative overflow-hidden">
              <div className="absolute inset-0 bg-gradient-to-r from-cyan-400/5 to-purple-500/5 animate-pulse"></div>
              <p className="text-white/90 text-xl leading-relaxed relative z-10">
              ...
              <div className="mt-6 text-cyan-400 font-medium text-lg relative z-10">- Sumon Ray</div>
            </div>
          </div>
        </div>
      </div>
